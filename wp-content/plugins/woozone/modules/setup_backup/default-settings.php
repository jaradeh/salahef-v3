...
$woozone_default_settings = array();
$woozone_default_settings = array_replace_recursive($woozone_default_settings, array(
	'disable_amazon_checkout' => 'no',
	'services_used_forip' => 'www.geoplugin.net',
	'charset' => '',
	'product_buy_is_amazon_url' => 'yes',
	'product_url_short' => 'no',
...
$woozone_settings_empty_selection = array(
	'questions'		=> array(
		'site_info'						=> '', //radio
		'site_install'					=> '', //radio
		'site_purpose'					=> '', //radio
...
$woozone_settings_per_questions_def = array_replace_recursive(array(), array(
	'disable_amazon_checkout' 		=> 'no',
	'onsite_cart'					=> 'yes',
	'90day_cookie'					=> 'yes',
	'show_review_tab'				=> 'yes',
...
$woozone_settings_per_questions = array();
//:: A
$woozone_settings_per_questions[0] = array_replace_recursive($woozone_settings_per_questions_def, array(
	'onsite_cart'					=> 'no',
	'checkout_email'				=> 'no',
	'number_of_images' 				=> '10',
...
//:: B - default
$woozone_settings_per_questions[1] = array_replace_recursive($woozone_settings_per_questions_def, array(
	'price_setup' 					=> 'amazon_or_sellers',
	'merchant_setup' 				=> 'amazon_or_sellers',
));
//:: C
$woozone_settings_per_questions[2] = array_replace_recursive($woozone_settings_per_questions_def, array(
